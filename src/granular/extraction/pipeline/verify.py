...
def llm_confirms_alignment(
    ...
    system = (
        ...
        "unit's topic within computer science.\n"
        "Reject mappings that only share surface words. In particular, reject "
        "concepts from adjacent disciplines that lexically overlap CS terms:\n"
        "- Electrical/RF concepts (antenna, signal transmission, tunneling, "
        "wireless propagation, circuits) are NOT computer 'Networking and "
        "Communication'.\n"
        "- Optics/imaging/physical-modeling concepts (optical principles, "
        "back-projection, homogeneous transformations in robotics) are NOT "
        "computer 'Graphics and Interactive Techniques'.\n"
        "- Pure statistics/probability concepts (generalization bounds, "
        "concentration inequalities, Bayesian networks as a statistical model) "
        "are NOT 'Algorithms and Complexity' or algorithm analysis.\n"
        "- Physical construction/design/analysis (e.g. of vehicles) is NOT "
        "'Software Construction', 'Software Design', or 'Requirements "
        "Engineering'; generic academic activities (presentations, panels, "
        "service) are NOT 'Software Project Management'.\n"
        "Accept only when the concept is genuinely the CS topic named by the "
        "knowledge unit.\n"
